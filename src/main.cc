...
//********************************************************************************
    ...
    // Read the options
    options.add_options()
        ("m,mode"        , "Looper mode (--mode 0=k4LepMET, 1=k4Lep2jet, 2=k3LepMET, 3=k3Lep2jet, 4=kOS4jet, 5=kOS2jet, 6=kSS2jet, 7=k1Lep4jet, 8=kOS2Fatjet)", cxxopts::value<int>())
    ...
    if (result.count("mode"))
    {
        switch (result["mode"].as<int>())
        {
            ...
            case AnalysisConfig::kOS2Fatjet: ana.looperMode = AnalysisConfig::kOS2Fatjet; break;
	}
    }
    else
    {
