...
void Begin_Common()
{
    ...
    //my addition
     hists_Common.addHistogram("h_Common_ngenW", 10, 0, 10, [&]() { return      ana.tx.getBranch<int>  ("Common_n_W" ) ; });      
     hists_Common.addHistogram("h_Common_ngenZ", 10, 0, 10, [&]() {  return      ana.tx.getBranch<int>  ("Common_n_Z" )   ; } ); 
    //   
